        ...
        >
          ...
          <h1 className="text-6xl lg:text-7xl font-bold text-white mb-8 !leading-[1.1] tracking-tight">
            ...
            {homepage.heroHighlightedText && (
              <span className="text-brand-gold">{homepage.heroHighlightedText}</span>
            )}
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8 mb-16">
            ...
            <a href="#case-studies" className="text-white/80 font-bold border-b border-white/20 pb-1 hover:text-white hover:border-brand-gold transition-all">
          ...
          <div className="flex flex-wrap gap-x-8 gap-y-4 opacity-50">
            {homepage.trustPoints.map((point) => (
              <div key={point} className="flex items-center gap-2">
                ...
                <span className="text-[10px] uppercase font-bold tracking-widest">{point}</span>
              </div>
            ))}
          </div>
        </motion.div>
            ...
            <div className="w-full max-w-[440px] bg-[#0D1631] rounded-2xl border border-white/10 p-10 shadow-[0_0_50px_-12px_rgba(197,160,89,0.3)] relative group">
              ...
              <div className="relative">
                <div className="flex justify-between items-center mb-10">
                  <h3 className="text-2xl font-bold !text-white">Start Your Estimate</h3>
                  <span className="text-brand-gold text-sm font-mono font-bold tracking-widest">Step 01/07</span>
                </div>

                <p className="text-[11px] text-white/40 mb-8 font-black uppercase tracking-[0.2em]">What do you need help with?</p>
                ...
                <div className="grid grid-cols-1 gap-4">
                  ...
                  <div className="p-5 rounded-xl border border-brand-gold bg-brand-gold/10 flex items-center justify-between cursor-pointer">
                    <span className="font-bold text-brand-gold">Website Redesign</span>
                ...
                <button className="w-full mt-10 bg-white/5 border border-white/10 py-4 rounded-lg text-white font-black hover:border-brand-gold hover:bg-brand-gold/20 transition-all uppercase tracking-[0.2em] text-[10px]">
                  Next Question
                </button>
