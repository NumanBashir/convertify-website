        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-4xl md:text-5xl font-extrabold mb-6">
              Selected work built for <span className="text-brand-gold">clarity and growth</span>.
            </h2>
            <p className="text-lg text-brand-beige/60">
              We help businesses across different industries build professional websites that get results.
            </p>
          </div>
          <motion.a 
            href="#quote"
